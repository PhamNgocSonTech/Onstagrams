    ...
    <header className={cn("header")}>
      <div className={cn("content")}>
        ...
        <div className={cn("search")}>
          ...
          />
          {clearBtn && (
            <button className={cn("clear-btn")} onClick={handleDeleteText}>
          ...
          {didLogin ? (
            <>
              <div className={cn("message-icon")}>
                <img src={send} onClick={() => console.log(didLogin)}></img>
              ...
              <div
                ...
                <img src={didLogin.avatar} className={cn("avt")} alt="avt" />
            ...
            <>
              <Button onClick={handleClickLoginButton} primary>
                Log in
              </Button>
      ...
      <AnimatePresence>
        {isShowLogInPanel && (
          <Login key={"login"} handleClosePanel={setIsShowLogInPanel} />
        )}
      </AnimatePresence>
    </header>
  );
